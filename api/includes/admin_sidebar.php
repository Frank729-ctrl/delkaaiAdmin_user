...
<aside class="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <a href="/admin/dashboard" class="nav-link <?= $active_page === 'dashboard' ? 'active' : '' ?>">
    ...
    <a href="/admin/keys" class="nav-link <?= $active_page === 'keys' ? 'active' : '' ?>">
    ...
    <a href="/admin/users" class="nav-link <?= $active_page === 'users' ? 'active' : '' ?>">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
      Developers
    </a>

    <a href="/admin/metrics" class="nav-link <?= $active_page === 'metrics' ? 'active' : '' ?>">
    ...
    <a href="/admin/security" class="nav-link <?= $active_page === 'security' ? 'active' : '' ?>">
