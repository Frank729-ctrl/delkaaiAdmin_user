<?php
/**
 * Support chat proxy for the developer console floating widget.
 * Calls /v1/admin/console-support (master-key auth) and returns JSON.
 */
...
if (!$session) {
    $session = 'console-' . $user_id;
}

$ch = curl_init(rtrim(DELKAI_API_URL, '/') . '/v1/admin/console-support');
